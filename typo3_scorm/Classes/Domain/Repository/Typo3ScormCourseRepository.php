 ...
 ***************************************************************/
 ...
 /**
 * The repository for Typo3ScormCourse
 * 
 * @package TYPO3
 * @subpackage TYPO3
 ...
 */
class Typo3ScormCourseRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
     ...
     * findByCloudId
     * 
     * @see TYPO3\CMS\Extbase\Persistence.Repository::findByCloudId()
     */
	public function findByCloudId($cloud_id, $ignoreEnableFields = FALSE) {		
		$query = $this->createQuery();
		$query->getQuerySettings()->setIgnoreEnableFields($ignoreEnableFields);
		return $query->matching(
			$query->equals('cloud_id', $cloud_id)
		)->execute()->getFirst();
	}  
