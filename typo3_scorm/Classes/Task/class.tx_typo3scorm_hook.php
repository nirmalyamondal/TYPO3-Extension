...
/**
 * Service "Typo3 SCORM SSO HOOK" for the "typo3_scorm" extension.
 *
 * @author	Typo3 <typo3india@gmail.com>
 * @package	TYPO3
 * @subpackage	tx_typo3scorm
 */
class tx_typo3scorm_hook {
	var $prefixId			= 'tx_typo3scorm_hook';		// Same as class name
	var $scriptRelPath		= 'class.tx_typo3scorm_hook.php';	// Path to this script relative to the extension dir.
	var $extKey				= 'typo3_scorm';	// The extension key.
	var $scormuser			= array();
	var $scormt3ecourses	= array();

	function _typo3T3user2scorm() {	
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typo3_scorm/class.tx_typo3scorm_hook.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typo3_scorm/class.tx_typo3scorm_hook.php']);
}
